...
$friend = $friends[$i];
$app = "Status Post";
$note = $log_username.' posted on: <br /><a class="atlast" href="users.php?u='.$account_name.'#status_'.$id.'">'.$account_name.'&#39;s Profile</a>';
...
$app = "Status Reply";
$note = $log_username.' commented here:<br /><a href="users.php?u='.$account_name.'#status_'.$osid.'">Click here to view the conversation</a>';
